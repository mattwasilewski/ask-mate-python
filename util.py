...
def handle_deleting_question(question_id):
    ...
    data_manager.delete_data_by_question_id(question_id, 'comment')
    data_manager.delete_data_by_question_id(question_id, 'answer')
    data_manager.delete_data(question_id, 'question')
